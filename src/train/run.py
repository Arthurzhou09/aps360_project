...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="/Users/arthurzhou/github/aps360_project/src/train/output", help="Directory to save the output.")
    parser.add_argument("--pdb_id", type=str, default="1BTL",required=True, help="PDB ID for the protein structure.")
    ...
    train_df, val_df, test_df = split_by_position(dms, train_size=cfg.data.train_size, val_size=cfg.data.val_size,)
    ...
    train(model=model_gnn, 
          ...
          train_loader=train_loader,
            ...
            optimizer=torch.optim.AdamW(model_gnn.parameters(), lr=cfg.train.learning_rate, weight_decay=cfg.train.weight_decay),
